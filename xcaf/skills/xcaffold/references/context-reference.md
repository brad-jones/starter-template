...
kind: context version: "1.0"

# ── Identity ─────────────────────────────────────────────────

name: my-context # REQUIRED. Lowercase + hyphens. Pattern: ^[a-z0-9-]+$ description: "..." # Optional. Purpose of this
context block.
...
Your context instructions here. This body text is compiled verbatim into the provider's root instruction file (e.g.,
CLAUDE.md).

Use kind: context for workspace-level ambient instructions shared across all agents — project conventions, coding
standards, tool policies.
