...
kind: rule version: "1.0"

# ── Identity ─────────────────────────────────────────────────

name: my-rule # REQUIRED. Lowercase + hyphens. Pattern: ^[a-z0-9-]+$ description: "..." # Optional. What this rule
enforces.
...
Your rule instructions here. This becomes the rule body injected into agent context when the activation condition is
met.

All providers that support this rule will receive this body verbatim, unless overridden via targets: above.
